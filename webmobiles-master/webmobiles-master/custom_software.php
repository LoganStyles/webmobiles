    	...
    	<div class="container" style="margin-top:40px; margin-bottom:40px">
        	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
            	<div class="widget padding-top">
                	<h3>  CUSTOM <span> SOFTWARE</span> DEVELOPMENT </h3>
                    ...
                    <P>
                    We recognize that successful software integration and implementation can bring big changes to your business processes. With the high risks and rewards involved, we take every opportunity to find methods for making our software development faster, better, on schedule and within budget.                    </P>
