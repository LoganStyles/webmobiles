    	...
    	<div class="container" style="margin-top:40px; margin-bottom:40px">
        	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
            	<div class="widget padding-top">
                    <h3>  ICT <span> CONSULTANCY</span>  </h3>
                    <p>
                    In the field of ICT we provide services related to the implementation of system analyses, we prepare and manage the integration of software and provide evaluation of the impact of the implementation of measures in the field of ICT.             </p>
                 
                    <p>
                    An important area of our services is to perform analyses which are necessary for better development of new software solutions and their implementation.

                    </p>
                    
                    <P>
                    Our ICT Consulting Services helps businesses and organizations manage small, medium and complex IT projects from inception through to its completion and maintenance phases. We ensure that it meets your specified objectives and deadlines whilst ensuring that we work within your budget. Our team of experienced consultants will utilize all resources available for the project and will ensure that performance, time and reliability is not compromised.                    </P>
        	...
        	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
            	<div class="wow fadeInRight margin-top">
					<img class=" img-responsive" src="images/consultant.png" alt="">
                </div>
			</div><!-- end col-lg-6 -->
		</div><!-- end container -->
